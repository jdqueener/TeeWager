...
const styles = StyleSheet.create({
  ...
  strokePlayer: { flex: 1, alignItems: 'center', gap: 4 },
  strokeName:   { fontSize: 12, fontWeight: '700', color: colors.textMid },
  strokeCounter:{ flexDirection: 'row', alignItems: 'center', gap: 6 },
  strokeBtn:    { width: 28, height: 28, borderRadius: 14, backgroundColor: colors.green, justifyContent: 'center', alignItems: 'center' },
  strokeBtnText:{ color: colors.white, fontSize: 18, fontWeight: '300', lineHeight: 22 },
  strokeVal:    { width: 36, height: 36, borderRadius: radius.sm, backgroundColor: colors.offWhite, justifyContent: 'center', alignItems: 'center' },
  strokeNum:    { fontSize: 18, fontWeight: '800', color: colors.textDark },
